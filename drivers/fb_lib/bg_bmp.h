...
extern __s32   get_file_head( HBMP hbmp ,bmp_file_head_t *file_head);
extern __s32   get_info_head( HBMP hbmp ,bmp_info_head_t *info_head);
extern __s32   get_data( HBMP hbmp ,void *data);
